...
function applyAthletesUi() {
    ...
    console.log("Applying athletes UI. Can edit athletes:", canEditAthletes());
}
...
async function startEdit(id) {
    ...
    document.getElementById("teamId").value = a.teamId ?? "";
...
document.getElementById("athleteForm").addEventListener("submit", async (e) => {
    ...
    const teamRaw = document.getElementById("teamId").value;
